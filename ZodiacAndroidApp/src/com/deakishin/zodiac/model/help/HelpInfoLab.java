...
public class HelpInfoLab {
	...
	private HelpInfoLab(Context c) {
		...
		mInfos.add(new HelpInfo(
				c.getString(R.string.help_page_3, c.getString(R.string.checkpoint), c.getString(R.string.clear))));
		mInfos.add(new HelpInfo(
				c.getString(R.string.help_page_4, c.getString(R.string.revert), c.getString(R.string.clear))));
		mInfos.add(new HelpInfo(c.getString(R.string.help_page_5, c.getString(R.string.search),
				c.getString(R.string.keep_binding), c.getString(R.string.homophonic))));
		mInfos.add(new HelpInfo(c.getString(R.string.help_page_6)));
		mInfos.add(new HelpInfo(c.getString(R.string.help_page_7, c.getString(R.string.drawer_save_image),
				c.getString(R.string.ext_storage_folder_name) + "/"
						+ c.getString(R.string.ext_storage_image_folder_name))));
	}
